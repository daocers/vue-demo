  ...
  <div class="table">
    ...
    <el-table
      ...
      <el-table-column
        ...
        width="160">
        <template slot-scope="scope">
          <el-button type="primary" size="mini" @click="toClassCourseInfo('edit', scope.$index, scope.row)">查看课表
          </el-button>
  ...
  export default {
    ...
    methods: {
      ...
      toClassCourseInfo(classId) {
        this.$router.push("/classCourse?classId=" + classId);
      },
      /**
       * 查询
       */
      findByCondition: async function () {
        let data = await this.doPost("/compass/findClassCourse?pageNum=" + this.queryForm.pageNum + "&pageSize=" + this.queryForm.pageSize, this.queryForm);
